...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-sm-6">
              <div class="form-group mb-3">
                ...
                <select class="form-control select2" required="" name="proColor[]" multiple="multiple">
                  <option value="">Select</option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-sm-12 mb-3">
              <div class="form-group">
                ...
                <textarea name="note" rows="6" class="summernote form-control <?php $__errorArgs = ['note'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
$(document).ready(function () {
  ...
  $(".btn-increment-docs").click(function () {
    var html = $(".clone-docs").html();
    $(".increment-docs").after(html);
  });
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\ethisXampp\htdocs\Omit\alauegym_gadget\resources\views/backEnd/product/create.blade.php ENDPATH**/ ?>
                ...
                <form action="" method="POST"   enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="summernote form-control @error('short_desc') is-invalid @enderror" name="short_desc" rows="6" value="{{ old('short_desc') }}"  id="short_desc"></textarea>
                            @error('short_desc')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="summernote form-control @error('long_desc') is-invalid @enderror" name="long_desc" rows="6" value="{{ old('short_desc') }}"  id="long_desc"></textarea>
                            @error('long_desc')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

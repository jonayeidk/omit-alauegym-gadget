    ...
    <div id="wrapper">
              ...
              <li>
                ...
                <div class="collapse" id="sidebar-landing-page">
                  <ul class="nav-second-level">                   
                    ...
                    <li>
                      <a href="<?php echo e(route('blogcategory.all')); ?>"><i data-feather="file-plus"></i> Blog Category</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('blog.all')); ?>"><i data-feather="file-plus"></i> Blog All</a>
                    </li>
                  </ul>
                </div>
              </li>
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end"><a href="https://giftclubbd.com" target="_blank">Website Designed by: Gift Club BD</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->
...
<?php /**PATH F:\ethisXampp\htdocs\Omit\alauegym_gadget\resources\views/backEnd/layouts/master.blade.php ENDPATH**/ ?>
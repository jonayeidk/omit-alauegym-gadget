...
Route::group(['namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    Route::get('category/blog/{slug}', [FrontendController::class, 'category_blog'])->name('category.blog');
    Route::get('blog/single/{slug}', [FrontendController::class, 'single_blog'])->name('blog.blog');
...
Route::group(['namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    Route::get('bkash/payment/cancel',[BkashController::class,'cancel'])->name('url-payment-cancel');
    Route::get('bkash/payment/failed',[BkashController::class,'failed'])->name('url-payment-failed');
...
Route::group(['namespace'=>'Admin','middleware' => ['auth','lock','check_refer'],'prefix'=>'admin'], function() {
    ...
    Route::post('customer/ip-destroy', [CustomerManageController::class,'ipblock_destroy'])->name('customers.ipblock.destroy');
     ...
     // blog category
    Route::get('blogcategory/all', [BlogController::class,'blogcategory_all'])->name('blogcategory.all');

    Route::get('blogcategory/create', [BlogController::class,'blogcategory_create'])->name('blogcategory.create');
    Route::post('blogcategory/create', [BlogController::class,'blogcategory_store'])->name('blogcategory.create');
    Route::get('blogcategory/edit/{id}', [BlogController::class,'blogcategory_edit'])->name('blogcategory.edit');
    Route::post('blogcategory/edit/{id}', [BlogController::class,'blogcategory_update'])->name('blogcategory.edit');

    Route::get('blogcategory/delete/{id}', [BlogController::class,'blogcategory_delete'])->name('blogcategory.delete');

    // blog
    Route::get('blog/all', [BlogController::class,'blog_all'])->name('blog.all');

    Route::get('blog/create', [BlogController::class,'blog_create'])->name('blog.create');
    Route::post('blog/create', [BlogController::class,'blog_store'])->name('blog.create');
    Route::get('blog/edit/{id}', [BlogController::class,'blog_edit'])->name('blog.edit');
    Route::post('blog/edit/{id}', [BlogController::class,'blog_update'])->name('blog.edit');

                ...
                <div class="mobile-logo">
                    ...
                    <div class="menu-bag">
                        <p class="margin-shopping">
                              <a href="<?php echo e(route('customer.checkout')); ?>" class="cart-dialog" id="cart-qty">
                            ...
                            <div class="col-sm-12">
                                <div class="catagory_menu">
                                    <ul class="heder__category">
                                        ...
                                        <div><li><a href="<?php echo e(route('blogs')); ?>">Blog</a></li></div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
								...
								<p><span style="color: white;">Copyright © <?php echo e(date('Y')); ?> <?php echo e($generalsetting->name); ?>. All rights reserved </span> | <span style="color: white;">Website Designed by: <a href="https://www.giftclubbd.com"><span style="color: white;">Gift Club BD</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH F:\ethisXampp\htdocs\Omit\alauegym_gadget\resources\views/frontEnd/layouts/master.blade.php ENDPATH**/ ?>
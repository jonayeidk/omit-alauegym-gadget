                ...
                <div class="mobile-logo">
                    ...
                    <div class="menu-bag">
                        <p class="margin-shopping">
                              <a href="{{route('customer.checkout')}}" class="cart-dialog" id="cart-qty">
                            ...
                            <div class="col-sm-12">
                                <div class="catagory_menu">
                                    <ul class="heder__category">
                                        ...
                                        <div><li><a href="{{route('blogs')}}">Blog</a></li></div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
								...
								<p><span style="color: white;">Copyright © {{ date('Y') }} {{$generalsetting->name}}. All rights reserved </span> | <span style="color: white;">Website Designed by: <a href="https://www.giftclubbd.com"><span style="color: white;">Gift Club BD</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>

                    ...
                    <form action="<?php echo e(route('customer.ordersave')); ?>" method="POST" data-parsley-validate="">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h6>To confirm your order, fill in the information and click the "Buy Now" button.</h6>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <button class="order_place" type="submit">Buy Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\ethisXampp\htdocs\Omit\alauegym_gadget\resources\views/frontEnd/layouts/customer/checkout.blade.php ENDPATH**/ ?>
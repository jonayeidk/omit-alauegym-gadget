...
class BkashController extends Controller
{
    ...
    public function callback(Request $request)
    {
        ...
        if(isset($allRequest['status']) && $allRequest['status'] == 'failure'){
            ...
            return redirect()->route('url-payment-failed', ['orderId' => $allRequest['orderId']]);
            ...
            return redirect()->route('url-payment-cancel', ['orderId' => $allRequest['orderId']]);
            // return redirect('customer/payment-cancel/'.$allRequest['orderId']);
        }else{
    ...
    public function cancel(Request $request){
        // $request->orderId // orderId exist here you can change order status from here
        Toastr::error('Opps, Your bkash payment canceled', 'Cancelled!');
        $allRequest = $request->all();
        $order = Order::where('id',$allRequest['orderId'])->first();
